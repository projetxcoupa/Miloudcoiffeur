        ...
        <div className="min-h-screen bg-cyber-dark text-white selection:bg-cyber-neon selection:text-cyber-dark">
            ...
            <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-cyber-dark/80 backdrop-blur-xl border-b border-white/10 py-3' : 'bg-transparent py-6'}`}>
                <div className="container mx-auto px-6 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <Button asChild className="btn-neon px-6">
                            <Link href="/book">
            ...
            >
                <div className="p-6">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <Button asChild className="btn-neon w-full py-6 text-lg mt-4">
                    ...
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Button asChild className="btn-neon h-14 px-10 text-lg group">
                                    <Link href="/book">
            ...
            <section className="py-24 border-t border-white/5">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <Button asChild className="btn-neon h-20 px-16 text-2xl font-black group">
                        <Link href="/book">
                            RÉSERVER MAINTENANT
