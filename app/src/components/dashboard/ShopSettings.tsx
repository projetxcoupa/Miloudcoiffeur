...
export function ShopSettings() {
    ...
    // Handle incoming shop data update
    useEffect(() => {
        if (shop) {
            setFormData({
                name: shop.name || '',
    ...
    if (!shop) {
        return <div className="flex items-center justify-center p-12 text-white/50 animate-pulse">Chargement des paramètres de la boutique...</div>;
    }
