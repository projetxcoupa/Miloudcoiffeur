...
const menuItems = [
    ...
    { id: 'activity', label: 'Activité', icon: List, href: '/dashboard/activity' },
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    const { user, userName, role, shopId, isLoading } = useAuth();
    ...
    const shop = shops[0] || { name: 'Salon', status: 'open' };
                    ...
                    <div className="p-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-white/50">{shop.name}</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <Button
                                    ...
                                    onClick={async () => {
                                        ...
                                        try {
                                            ...
                                            // Fallback: clear any legacy cookies
